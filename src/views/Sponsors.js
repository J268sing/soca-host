  ...
  return (
    ...
    >
      <div className="container pb-72" >
        ...
        <div className="ta-c text-color-high h2 bold fw-400 pt-48 pb-32 reveal-from-bottom" data-reveal-delay="200" > Our Sponsors  </div>

        <div className="ta-c  fw-400 pt-48 pb-32 reveal-from-bottom" data-reveal-delay="400" >



          <div className="aline-horizontal-sponsor to-flex-sponsor" style={{ backgroundColor: '' }} >


            <div className="to-flex" style={{ backgroundColor: 'white' }} >

              <Image
                className="has-shadow"
                className="to-fill-image"
                src={require('./../assets/images/SOCAlogo.png')}
            ...
            <div className="to-flex" style={{ backgroundColor: 'yellow' }} >
            ...
            <div className="to-flex" style={{ backgroundColor: 'blue' }} >
            ...
            <div className="to-flex" style={{ backgroundColor: 'green' }} >
